...
class App {
  ...
  dropDown(BuildContext context,
    ...
    return SizedBox(width:width ?? 100,
  ...
  menu(
      ...
      void Function(dynamic)? onSelected,IconData? icon,double? iconSize,Color? iconColor}) {
    return PopupMenuButton(
        iconSize:iconSize?? 18,
        icon:  Icon(icon??Icons.more_vert,color: iconColor??Colors.black87,),
  ...
  dialog(BuildContext context,
    ...
    showDialog(context: context,barrierDismissible:clickOutSideClose, builder: (BuildContext context) =>  _dialog);
  }
}
